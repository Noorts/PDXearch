...
struct GlobalPDXearchIndexPhysicalScanBindData {
	GlobalPDXearchIndexPhysicalScanBindData(DuckTableEntry &table, Index &index, idx_t limit,
...
class PhysicalGlobalPDXearchIndexFilteredScan : public PhysicalOperator {
public:
	static constexpr const PhysicalOperatorType TYPE = PhysicalOperatorType::EXTENSION;

public:
	PhysicalGlobalPDXearchIndexFilteredScan(PhysicalPlan &physical_plan, vector<LogicalType> types,
	                                        unique_ptr<GlobalPDXearchIndexPhysicalScanBindData> bind_data,
