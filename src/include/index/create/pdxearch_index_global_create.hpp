...
class PhysicalCreateGlobalPDXearchIndex : public PhysicalOperator {
public:
	static constexpr const PhysicalOperatorType TYPE = PhysicalOperatorType::EXTENSION;

public:
	PhysicalCreateGlobalPDXearchIndex(PhysicalPlan &physical_plan, const vector<LogicalType> &types_p,
